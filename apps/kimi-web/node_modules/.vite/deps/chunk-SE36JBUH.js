...
var registerDefaultLayoutLoaders = __name(() => {
  registerLayoutLoaders([
    {
      name: "dagre",
      loader: __name(async () => await import("./dagre-BM42HDAG-ZMRWY2NO.js"), "loader")
    },
    ...true ? [
      {
        name: "cose-bilkent",
        loader: __name(async () => await import("./cose-bilkent-S5V4N54A-JRQMN5VP.js"), "loader")
      }
    ] : []
  ]);
...
//# sourceMappingURL=chunk-SE36JBUH.js.map
