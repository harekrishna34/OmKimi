...
// ../../node_modules/.pnpm/@intlify+shared@11.4.8/node_modules/@intlify/shared/dist/shared.mjs
...
// ../../node_modules/.pnpm/@intlify+message-compiler@11.4.8/node_modules/@intlify/message-compiler/dist/message-compiler.mjs
...
function createCompileError(code, loc, options = {}) {
  ...
  const msg = false ? format((messages || errorMessages)[code] || "", ...args || []) : code;
...
// ../../node_modules/.pnpm/@intlify+core-base@11.4.8/node_modules/@intlify/core-base/dist/core-base.mjs
...
function createCoreError(code) {
  return createCompileError(code, null, false ? { messages: errorMessages2 } : void 0);
}
var errorMessages2 = {
...
function resolveMessageFormat(context, key, locale, fallbackLocale, fallbackWarn, missingWarn) {
  ...
  for (let i = 0; i < locales.length; i++) {
    ...
    const emitter = false ? context.__v_emitter : void 0;
    if (false) {
      if (emitter) {
        emitter.emit("fallback", {
          type,
...
// ../../node_modules/.pnpm/vue-i18n@11.4.8_vue@3.5.35_typescript@6.0.2_/node_modules/vue-i18n/dist/vue-i18n.mjs
var VERSION2 = "11.4.8";
...
function createI18nError(code, ...args) {
  return createCompileError(code, null, false ? { messages: errorMessages3, args } : void 0);
}
var errorMessages3 = {
...
function defineMixin(vuei18n, composer, i18n) {
  return {
    ...
    mounted() {
      if (__VUE_PROD_DEVTOOLS__ && true && this.$i18n) {
        const instance = getCurrentInstance2();
        if (!instance) {
          return;
        }
    ...
    unmounted() {
      ...
      const _vueI18n = this.$i18n;
      if (__VUE_PROD_DEVTOOLS__ && true && instance.__VUE_I18N__) {
        if (this.__v_emitter) {
